...
According to this European Standard, the flow rate characteristic parameter of a valve is the flow coefficient, $K_v$. The equation, the quantity subject to measurement and input quantities are the following.
...
A large number of more or less well-known model functions are builtin in $drc$.  These models are parameterized using a unified structure with the coefficients: 
