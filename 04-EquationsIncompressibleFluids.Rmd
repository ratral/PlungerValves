...
$$
  {F_L}^{-2} = \frac{(P_1 - F_F \cdot p_v)}{\Delta{P_{max}}} 
$$
However, it is more convenient to use the upstream pressure for most applications and the left equation values differ by a constant value of 1.0. 

$$
  {F_L}^{-2} = \frac{(P_2 - F_F \cdot p_v)}{\Delta{P_{max}}} + 1
$$
