...
\begin{equation} 
    F_{P} = \frac{1}{\sqrt{1+\frac{\sum{\zeta} \cdot \left(\frac{K_v}{d^2} \right)^2}{0.00214}}}
    = \left( \frac{\sum{\zeta} \cdot K_v^2}{0.00214 \cdot d^4} + 1 \right)^{-1/2}
(\#eq:Fp)
\end{equation} 
...
\begin{equation} 
  F_{LP} = \frac{F_L}{\sqrt{1 + F_L \cdot \frac{\sum{\zeta} \cdot \left(\frac{K_v}{d^2} \right)^2}{0.00214}}} 
  = F_L \cdot \left(\frac{\sum{\zeta} \cdot F_L^2 \cdot K_v^2}{0.00214 \cdot d^4} + 1 \right)^{-1/2}
(\#eq:Flp)
\end{equation} 
