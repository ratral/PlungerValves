...
```{r kv-kvs1-Example-2, echo=FALSE, fig.cap="Inherent Characteristic of the valve", warning=TRUE}
  ...
  # arrows_points <- tribble(
  #   ~x,                      ~y, 
  #   0,                       data_points$kv_kvs[1],
  #   data_points$position[1], data_points$kv_kvs[1],
  #   data_points$kv_kvs[1],   0
  # )
  
  plot_kv_kvs( data_analyse[i,]$kv.b, data_analyse[i,]$kv.d, 
               data_analyse[i,]$kv.e, data_analyse[i,]$typ) +
    geom_point( data = data_points, 
                aes( y = kv_kvs*100, x = position ), 
                colour = "black", size = 2) 
...
```{r kv-kvs2-Example-2, echo=FALSE, fig.cap="Inherent Characteristic of the valve", warning=TRUE}
  ...
  # arrows_points <- tribble(
  #   ~x,                      ~y, 
  #   0,                       data_points$kv_kvs[i],
  #   data_points$position[i], data_points$kv_kvs[i],
  #   data_points$kv_kvs[i],   0
  # )
