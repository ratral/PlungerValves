...
according to equation \@ref(eq:Fp) $F_p$ is equal to one ($1.0$); in the next examples, we will analyze dimensions with diameters smaller than the transport line size.
